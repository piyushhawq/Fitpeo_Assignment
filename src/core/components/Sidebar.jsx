...
<div className='flex justify-between items-center rounded-md hover:bg-blue-900 px-2 mb-8 mx-2'>
    <div className='flex items-center justify-between gap-2 px-2 py-2 cursor-pointer'>
        ...
        src="https://raw.githubusercontent.com/piyushhawq/Images/main/Piyush.jpeg"
        alt="user-pic"
        />
        <div className=''>
        <p className='text-gray-200 text-xs text-left'>Piyush</p>
        <p className='text-gray-100 opacity-40 text-[0.6rem]'>Frontend-Developer</p>
        </div>
    </div>
